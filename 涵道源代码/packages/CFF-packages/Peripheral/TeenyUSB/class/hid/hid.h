...
} __PACK_END hid_gamepad_report_t;
...
typedef struct __PACK_BEGIN
{
  ...
  int8_t  z;         ///< Delta z  movement of right analog-joystick
  int8_t  rz;        ///< Delta Rz movement of right analog-joystick
} __PACK_END hid_gamepad_ns_report_t;

/// HID Switch Gamepad Protocol Report.
typedef struct __PACK_BEGIN
{
  uint16_t hat : 4;  ///< Buttons mask for currently pressed buttons in the DPad/hat
  uint16_t buttons : 12;  ///< Buttons mask for currently pressed buttons
  uint8_t  lt;       ///< Delta Rx movement of analog left trigger
  uint8_t  rt;       ///< Delta Ry movement of analog right trigger
...
} __PACK_END hid_gamepad_xbox_report_t;
...
typedef enum
{
  GAMEPAD_XBOX_BUTTON_MINUS   = 0x01,
  GAMEPAD_XBOX_BUTTON_CAPTURE = 0x02,
  GAMEPAD_XBOX_BUTTON_THUMBL  = 0x04,
  GAMEPAD_XBOX_BUTTON_THUMBR  = 0x08,
  GAMEPAD_XBOX_BUTTON_LB      = 0x10,
  GAMEPAD_XBOX_BUTTON_RB      = 0x20,
  GAMEPAD_XBOX_BUTTON_HOME    = 0x40,
  GAMEPAD_XBOX_BUTTON_A       = 0x100,
  GAMEPAD_XBOX_BUTTON_B       = 0x200,
  GAMEPAD_XBOX_BUTTON_X       = 0x400,
  GAMEPAD_XBOX_BUTTON_Y       = 0x800,
}hid_gamepad_xbox_button_bm_t;
...
typedef enum
{
  GAMEPAD_XBOX_HAT_CENTERED   = 0,  ///< DPAD_CENTERED
  GAMEPAD_XBOX_HAT_UP         = 1,  ///< DPAD_UP
  GAMEPAD_XBOX_HAT_DOWN       = 2,  ///< DPAD_DOWN
  GAMEPAD_XBOX_HAT_LEFT       = 4,  ///< DPAD_LEFT
  GAMEPAD_XBOX_HAT_UP_LEFT    = 5,  ///< DPAD_UP_LEFT
  GAMEPAD_XBOX_HAT_DOWN_LEFT  = 6,  ///< DPAD_DOWN_LEFT
  GAMEPAD_XBOX_HAT_RIGHT      = 8,  ///< DPAD_RIGHT
  GAMEPAD_XBOX_HAT_UP_RIGHT   = 9,  ///< DPAD_UP_RIGHT
  GAMEPAD_XBOX_HAT_DOWN_RIGHT = 10,  ///< DPAD_DOWN_RIGHT
}hid_gamepad_xbox_hat_t;
...
} __PACK_END hid_keyboard_report_t;
