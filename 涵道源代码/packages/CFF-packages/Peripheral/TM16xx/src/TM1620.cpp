...
TM1620::TM1620(TM16xx_PIN_TYPE dataPin, TM16xx_PIN_TYPE clockPin, TM16xx_PIN_TYPE strobePin, uint8_t numDigits, bool activateDisplay, uint8_t intensity)
...
void TM1620::setSegments(uint8_t segments, uint8_t position)
...
void TM1620::setSegments16(uint16_t segments, uint8_t position)
{ // method to send more than 8 segments (10 max for TM1620)
  ...
  if (position < _maxDisplays)
  {
    ...
    sendData((position << 1) | 1, (uint8_t)(segments >> 8) & 0x30);
  }
}
