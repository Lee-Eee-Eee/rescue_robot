...
TM16xx::TM16xx(TM16xx_PIN_TYPE dataPin, TM16xx_PIN_TYPE clockPin, TM16xx_PIN_TYPE strobePin, uint8_t maxDisplays, uint8_t nDigitsUsed, bool activateDisplay, uint8_t intensity)
{
  ...
  TM16xx_PIN_MODE(clockPin, PIN_MODE_OUTPUT);
  TM16xx_PIN_MODE(strobePin, PIN_MODE_OUTPUT);
