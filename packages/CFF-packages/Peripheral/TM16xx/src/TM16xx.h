...
#define bit(n) (1 << n)
#define TM16xx_PIN_TYPE   rt_base_t
#define TM16xx_PIN_MODE   rt_pin_mode
#define TM16xx_PIN_WRITE  rt_pin_write
#define TM16xx_PIN_READ   rt_pin_read
#define TM16xx_DELAY      rt_hw_us_delay
#define TM16xx_GET_TIME   rt_tick_get_millisecond
...
public:
   ...
   */
  TM16xx(TM16xx_PIN_TYPE dataPin, TM16xx_PIN_TYPE clockPin, TM16xx_PIN_TYPE strobePin, uint8_t maxDisplays, uint8_t nDigitsUsed, bool activateDisplay = true, uint8_t intensity = 7);
...
#define min(a,b)  ((a) > (b) ? (b) : (a))
  ...
  TM16xx_PIN_TYPE dataPin;
  TM16xx_PIN_TYPE clockPin;
  TM16xx_PIN_TYPE strobePin;
};
