...
TM1638::TM1638(TM16xx_PIN_TYPE dataPin, TM16xx_PIN_TYPE clockPin, TM16xx_PIN_TYPE strobePin, uint8_t numDigits, bool activateDisplay, uint8_t intensity)
...
void TM1638::setSegments(uint8_t segments, uint8_t position)
...
void TM1638::setSegments16(uint16_t segments, uint8_t position)
{ // method to send more than 8 segments (10 max for TM1638)
  ...
  if (position < _maxDisplays)
  {
    ...
    sendData((position << 1) | 1, (uint8_t)(segments >> 8) & 0x03);
  }
}

void TM1638::setLED(uint8_t color, uint8_t pos)
...
void TM1638::setLEDs(uint16_t leds)
{
