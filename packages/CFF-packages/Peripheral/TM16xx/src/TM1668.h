...
public:
  ...
  TM1668(TM16xx_PIN_TYPE dataPin, TM16xx_PIN_TYPE clockPin, TM16xx_PIN_TYPE strobePin, uint8_t numDigits = 4, bool activateDisplay = true, uint8_t intensity = 7, uint8_t displaymode = TM1668_DISPMODE_7x10);
  ...
  void setRGBLED(uint8_t color, uint8_t pos);
