...
public:
  ...
  TM1638(TM16xx_PIN_TYPE dataPin, TM16xx_PIN_TYPE clockPin, TM16xx_PIN_TYPE strobePin, uint8_t numDigits = 8, bool activateDisplay = true, uint8_t intensity = 7);
  ...
  virtual void setLEDs(uint16_t led);
