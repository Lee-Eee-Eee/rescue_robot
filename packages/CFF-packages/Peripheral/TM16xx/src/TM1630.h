...
public:
  ...
  TM1630(TM16xx_PIN_TYPE dataPin, TM16xx_PIN_TYPE clockPin, TM16xx_PIN_TYPE strobePin, uint8_t numDigits = TM1630_MAX_POS, bool activateDisplay = true, uint8_t intensity = 7);
