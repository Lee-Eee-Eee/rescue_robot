...
TM1616::TM1616(TM16xx_PIN_TYPE dataPin, TM16xx_PIN_TYPE clockPin, TM16xx_PIN_TYPE strobePin, uint8_t numDigits, bool activateDisplay, uint8_t intensity)
...
void TM1616::setSegments(uint8_t segments, uint8_t position)
...
{ // need to override clearDisplay to accommodate the memory layout used by TM1616
  for (uint8_t nPos = 0; nPos < _maxDisplays; nPos++)
